...
const html = fs.readFileSync(path.join(root, 'dist', 'en', 'revenue-calculator', 'index.html'), 'utf8');
const required = ['<title>Free Creator Revenue Calculator | YouTube, TikTok, AdSense, RPM | Pratix.io</title>', '<link rel="canonical" href="https://pratix.io/en/revenue-calculator" />', 'calculate', 'localStorage'];
